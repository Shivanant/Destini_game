...
class Storybrain {
  ...
  bool show = true;
  bool buttonVisible(_storynum) {
    if (_storynum == 5 || _storynum == 4 || _storynum == 3) {
      show = false;
    }
    return show;
  }
  ...
  void nextStory(int num) {
    show = true;
    if (_storynum == 0) {
      (num == 1) ? (_storynum = 2) : _storynum = 1;
    } else if (_storynum == 1) {
      (num == 1) ? (_storynum = 2) : _storynum = 3;
    } else if (_storynum == 2) {
      (num == 1) ? (_storynum = 5) : _storynum = 4;
    } else {
      restart();
    }
  }
